<html lang="en"><head>
  ...
  <title>CodePen - Daily UI #008 - 404 Page</title>
    <link rel="canonical" href="https://codepen.io/rafaelavlucas/pen/NWWQNjZ">
    ...
    <section class="wrapper">
        ...
        <div class="container">
            ...
            <div id="scene" class="scene" data-hover-only="false" style="transform: translate3d(0px, 0px, 0px) rotate(0.0001deg); transform-style: preserve-3d; backface-visibility: hidden; pointer-events: none;">
                ...
                <div class="circle" data-depth="1.2" style="transform: translate3d(-113.6px, 40.3px, 0px); transform-style: preserve-3d; backface-visibility: hidden; position: relative; display: block; left: 0px; top: 0px;"></div>

                <div class="one" data-depth="0.9" style="transform: translate3d(-85.2px, 30.2px, 0px); transform-style: preserve-3d; backface-visibility: hidden; position: absolute; display: block; left: 0px; top: 0px;">
                    <div class="content">
                ...
                <div class="two" data-depth="0.60" style="transform: translate3d(-56.8px, 20.2px, 0px); transform-style: preserve-3d; backface-visibility: hidden; position: absolute; display: block; left: 0px; top: 0px;">
                    <div class="content">
                        <span class="piece"></span>
                        <span class="piece"></span>
                        <span class="piece"></span>
                ...
                <div class="three" data-depth="0.40" style="transform: translate3d(-37.9px, 13.4px, 0px); transform-style: preserve-3d; backface-visibility: hidden; position: absolute; display: block; left: 0px; top: 0px;">
                    <div class="content">
                        <span class="piece"></span>
                        <span class="piece"></span>
                        <span class="piece"></span>
                ...
                <p class="p404" data-depth="0.50" style="transform: translate3d(-47.3px, 16.8px, 0px); transform-style: preserve-3d; backface-visibility: hidden; position: absolute; display: block; left: 0px; top: 0px;">404</p>
                <p class="p404" data-depth="0.10" style="transform: translate3d(-9.5px, 3.4px, 0px); transform-style: preserve-3d; backface-visibility: hidden; position: absolute; display: block; left: 0px; top: 0px;">404</p>

            </div>

            <div class="text">
                <article>
                    <p>Uh oh! Looks like you got lost. <br>Check your link carefully.</p>
                    <button onclick=dashboard()>My Dashboard</button>
                </article>
            </div>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
      <script>
      var teacherId = '<%= session.getAttribute("username") %>';
...
//# sourceURL=pen.js
        function dashboard(){
            ...
            else if(teacherId.startsWith("t")){
                window.location.href = "teacher.jsp";
            }
            else if(teacherId.startsWith("2")){
                window.location.href = "student.jsp";
            }
            else if(teacherId.startsWith("admin")){
